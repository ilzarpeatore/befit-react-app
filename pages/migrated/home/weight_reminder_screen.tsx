...
function useStyle() {
  return useResponsiveStyleSheet({
    ...
    subtitle: { fontSize: 14, fontFamily: FONT.regular, color: C.gray50, marginBottom: 28 },
    ...
    dayLabel: { fontSize: 14, fontFamily: FONT.semiBold, color: C.gray50 },
    ...
    hourText: { fontSize: 13, fontFamily: FONT.medium, color: C.gray50 },
