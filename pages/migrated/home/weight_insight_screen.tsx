...
function useStyle() {
  return useResponsiveStyleSheet({
    ...
    bmiLabel: { fontSize: 14, fontFamily: FONT.medium, color: C.gray50 },
    ...
    barVal: { fontSize: 10, fontFamily: FONT.medium, color: C.gray50, marginBottom: 4 },
    barDay: { fontSize: 12, fontFamily: FONT.medium, color: C.gray50 },
    ...
    gaugeSubtitle: { fontSize: 12, fontFamily: FONT.regular, color: C.gray50 },
    ...
    metricUnit: { fontSize: 12, fontFamily: FONT.regular, color: C.gray50 },
