...
function useStyle() {
  return useResponsiveStyleSheet({
    ...
    subtitle: { fontSize: 14, fontFamily: FONT.regular, color: C.gray5, marginBottom: 24 },
    ...
    dayLabelText: { fontSize: 12, fontFamily: FONT.medium, color: C.gray5 },
    ...
    hourText: { fontSize: 14, fontFamily: FONT.medium, color: C.gray5 },
    ...
    skipBtnText: { fontSize: 14, fontFamily: FONT.medium, color: C.gray5 },
  });
}
