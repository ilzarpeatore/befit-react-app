...
function useStyle() {
  return useResponsiveStyleSheet({
    ...
    unitBtnText: { fontSize: 14, fontFamily: FONT.semiBold, color: C.gray5 },
    ...
    weightUnit: { fontSize: 18, fontFamily: FONT.medium, color: C.gray5, marginTop: 4 },
    rulerLabel: { fontSize: 13, fontFamily: FONT.regular, color: C.gray5, textAlign: "center", marginBottom: 8 },
