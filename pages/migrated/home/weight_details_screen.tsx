...
function useStyle() {
  return useResponsiveStyleSheet({
    ...
    heroLabel: { fontSize: 14, fontFamily: FONT.medium, color: C.gray5, marginBottom: 4 },
    ...
    metricSubtitle: { fontSize: 11, fontFamily: FONT.regular, color: C.gray10 },
    ...
    barValue: { fontSize: 10, fontFamily: FONT.medium, color: C.gray5, marginBottom: 4 },
    barLabel: { fontSize: 11, fontFamily: FONT.medium, color: C.gray5 },
