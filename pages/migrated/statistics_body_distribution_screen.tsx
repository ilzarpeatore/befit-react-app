...
export default function StatisticsBodyDistributionScreen(props: Props) {
  ...
  // Solo se listan los grupos musculares con al menos 1 serie registrada ese
  // día — mostrar la tabla completa (incluyendo grupos con 0 series) no
  // aporta nada si solo se han entrenado dos o tres grupos. El mapa corporal
  // (heatmap) se deja con el dataset completo tal cual, solo se filtra la tabla.
        ...
        <View style={s.tableCard}>
          ...
          {trainedMuscles.length === 0 ? (
            <View style={s.tableRow}>
              <Text style={s.tableEmptyText}>Sin series registradas ese día.</Text>
            </View>
          ) : (
