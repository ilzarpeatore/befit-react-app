...
import { SafeAreaView, ScrollView, Image, ActivityIndicator, Dimensions, Modal, Pressable as RNPressable } from 'react-native';
  ...
  return (
    <SafeAreaView style={{ flex: 1 }} className="bg-background">
      ...
      >
        ...
        >
          <RNPressable className="bg-background rounded-t-lg p-6" onPress={(e) => e.stopPropagation()}>
            <Box className="w-10 h-1 rounded-pill bg-muted self-center" style={{ marginBottom: 16 }} />
