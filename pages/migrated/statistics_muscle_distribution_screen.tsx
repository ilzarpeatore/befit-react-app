      ...
      <ScrollView contentContainerStyle={s.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.grid2x2}>
          ...
          <View style={s.kpiCard}>
            ...
            <Text style={s.kpiValue}>{formatDuration(currentStats.durationSeconds)}</Text>
            <DeltaText current={currentStats.durationSeconds} previous={previousStats.durationSeconds} format={formatDuration} />
          </View>
          <View style={s.kpiCard}>
