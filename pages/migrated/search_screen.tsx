...
import { ScrollView, Image, SafeAreaView, Dimensions, Modal } from 'react-native';
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Modal visible={showBottomSheet} transparent animationType="slide">
        <Pressable className="flex-1 justify-end" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }} onPress={() => setShowBottomSheet(false)}>
          <Pressable
            className="bg-card"
            style={{ borderTopLeftRadius: 18, borderTopRightRadius: 18, padding: 24, maxHeight: '60%' }}
            onPress={(e) => e.stopPropagation()}
          >
            <Box className="self-center" style={{ width: 40, height: 4, borderRadius: 2, backgroundColor: C.gray60, marginBottom: 16 }} />
