        ...
        <Box className="bg-background rounded-t-lg" style={{ paddingTop: 16, paddingBottom: 40 }}>
          ...
          {blog?.bibliography && blog.bibliography.trim().length > 0 && (
            <Box
              ...
              style={{ marginTop: 24, marginHorizontal: 16, padding: 16 }}
            >
              <Pressable
              ...
              >
                ...
                <Text weight="bold" className="flex-1">Fuente / Bibliografía</Text>
                <Icon
              ...
              {bibliographyOpen && (
                <>
                  <Box style={{ height: 1, backgroundColor: C.gray60, marginTop: 12, marginBottom: 12 }} />
                  <VStack space="sm">
