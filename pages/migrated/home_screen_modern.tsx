...
export default function HomeScreenModern(props: HomeScreenModernProps) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    nutritionCalValue: { fontSize: r(20), fontFamily: FONT.extraBold, color: C.white },
              ...
              <View style={styles.nutritionTopRow}>
                ...
                <View style={styles.nutritionCalCenter}>
                  <AnimatedRing
                    ...
                    duration={900}
                  >
                    <Text style={styles.nutritionCalValue} numberOfLines={1} adjustsFontSizeToFit>{dailyPlan.eaten ?? 0}</Text>
