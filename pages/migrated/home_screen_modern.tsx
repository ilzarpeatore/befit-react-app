  ...
  const renderTodayItem = (item: TodayItem, i: number) => {
    ...
    if (item.kind === 'checkin') {
      ...
      return (
        ...
        >
          <Box style={styles.todayWorkoutTopRow}>
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {state.user?.is_personal_client && (
          <Box style={styles.myProgramBadge}>
        ...
        {todayItems.length > 0 ? (
          <>
            <Box style={styles.todayWorkoutCard}>
          ...
          <Box style={[styles.todayWorkoutCard, { alignItems: 'center' }]}>
        ...
        <Box style={styles.activityCard}>
          <Box style={styles.activityWeekRow}>
        ...
        {habits.length > 0 ? (
            ...
            {habits.slice(0, 3).map((h, i) => (
              ...
              >
                ...
                <Box style={styles.todayWorkoutTopRow}>
                  ...
                  <Box style={{ flex: 1, marginLeft: r(10) }}>
          ...
          <Pressable style={styles.todayWorkoutCard} onPress={() => navigation?.navigate('MigratedHabitAdd')}>
            <Box style={styles.todayWorkoutTopRow}>
        ...
        <Box style={styles.nutritionCard}>
          {dailyPlan ? (
            <>
              <Box style={styles.nutritionTopRow}>
        ...
        <Box style={[styles.sleepCard, { alignItems: 'center', paddingVertical: r(20) }]}>
        ...
        <Pressable style={styles.supportCard} onPress={() => navigation?.navigate('MigratedChatting', { isDirect: true })}>
          <Box style={{ flex: 1 }}>
      ...
      <Modal visible={showMenu} transparent animationType="slide" onRequestClose={() => setShowMenu(false)}>
        <Pressable style={styles.menuOverlay} onPress={() => setShowMenu(false)}>
          <Pressable style={styles.menuSheet} onPress={(e) => e.stopPropagation()}>
            ...
            <Box style={styles.menuDivider} />

            <Pressable style={styles.menuItem} onPress={() => navigateFromMenu('MigratedProfile')}>
            ...
            <Pressable style={styles.menuItem} onPress={() => navigateFromMenu('MigratedFavourite')}>
            ...
            <Pressable style={styles.menuItem} onPress={() => navigateFromMenu('MigratedCommunity')}>
