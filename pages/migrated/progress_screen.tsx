    ...
    <View style={s.container}>
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={s.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity style={s.moreMetricsLink} onPress={() => props.navigation?.navigate('MigratedBodyMetrics')}>
...
const s = StyleSheet.create({
  ...
  moreMetricsLink: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 10, paddingHorizontal: 4 },
  moreMetricsText: { fontSize: 12.5, color: C.gray40, fontFamily: FONT.medium },
