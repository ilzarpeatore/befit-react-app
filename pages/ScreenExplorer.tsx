...
const ALL_SCREENS: ScreenItem[] = [
  ...
  { name: 'Workout', route: 'Workout', category: 'Original - Main', file: 'Workout.tsx' },
  ...
  { name: 'Full Workout', route: 'MigratedFullWorkout', category: 'Migrated - Workout', file: 'full_workout_screen.tsx' },
