...
const CANONICAL_TO_MACRO: Record<string, MacroMuscleGroup> = {
  ...
  // 'Deltoides anterior' es el body_parts.title REAL sembrado en BD (id 19)
  // que usa MuscleVolumeService::resolvePrimaryGroups como grupo primario —
  // 'Deltoides frontal' es solo el sinonimo EMG que usan las RULES de reparto
  // secundario, nunca aparece como primario. Sin esta entrada, cualquier
  // ejercicio cuyo bodypart primario fuera "Deltoides anterior" (muy comun,
  // ej. press de hombro) desaparecia sin mas del radar de "Distribucion de
  // los musculos" y del recuento de series por zona (macroGroupFor()===null),
  // aunque el heatmap corporal si lo pintaba bien (CANONICAL_TO_BODY_MUSCLES
  // arriba si tenia el sinonimo). Bug persistente reportado 2026-08-13.
