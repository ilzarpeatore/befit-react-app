...
const ExerciseDetailScreen = React.lazy(() => import('@pages/migrated/exercise_detail_screen'));
...
const ExerciseListScreen = React.lazy(() => import('@pages/migrated/exercise_list_screen'));
...
const MissingDetailsScreen = React.lazy(() => import('@pages/migrated/missing_details_screen'));
...
const ProductDetailScreen = React.lazy(() => import('@pages/migrated/product_detail_screen'));
const ProductScreen = React.lazy(() => import('@pages/migrated/product_screen'));
const ProfileScreenMigrated = React.lazy(() => import('@pages/migrated/profile_screen'));
const ProfileScreenSandow = React.lazy(() => import('@pages/migrated/profile_screen_sandow'));
...
const ViewAllProductScreen = React.lazy(() => import('@pages/migrated/view_all_product_screen'));
...
const ViewProductCategoryScreen = React.lazy(() => import('@pages/migrated/view_product_category_screen'));
...
const LogWeightFormScreen = React.lazy(() => import('@pages/migrated/home/log_weight_form_screen'));
const LogWeightKeyboardScreen = React.lazy(() => import('@pages/migrated/home/log_weight_keyboard_screen'));
const ManageHealthMetricsScreen = React.lazy(() => import('@pages/migrated/home/manage_health_metrics_screen'));
const SandowScoreScreenHome = React.lazy(() => import('@pages/migrated/home/sandow_score_screen'));
const ScoreBreakdownRadarScreenHome = React.lazy(() => import('@pages/migrated/home/score_breakdown_radar_screen'));
...
const WeightDeadlineScreen = React.lazy(() => import('@pages/migrated/home/weight_deadline_screen'));
const WeightDetailsScreen = React.lazy(() => import('@pages/migrated/home/weight_details_screen'));
const WeightGoalCompletedScreen = React.lazy(() => import('@pages/migrated/home/weight_goal_completed_screen'));
const WeightGoalSetScreenHome = React.lazy(() => import('@pages/migrated/home/weight_goal_set_screen'));
const WeightGoalSummaryScreen = React.lazy(() => import('@pages/migrated/home/weight_goal_summary_screen'));
const WeightHistoryScreen = React.lazy(() => import('@pages/migrated/home/weight_history_screen'));
const WeightInsightScreenHome = React.lazy(() => import('@pages/migrated/home/weight_insight_screen'));
const WeightLoggedScreenHome = React.lazy(() => import('@pages/migrated/home/weight_logged_screen'));
const WeightLoseGainChoiceScreen = React.lazy(() => import('@pages/migrated/home/weight_lose_gain_choice_screen'));
const WeightReminderScreen = React.lazy(() => import('@pages/migrated/home/weight_reminder_screen'));
const WeightScreenMigrated = React.lazy(() => import('@pages/migrated/home/weight_screen'));
const WeightSetGoalScreen = React.lazy(() => import('@pages/migrated/home/weight_set_goal_screen'));
