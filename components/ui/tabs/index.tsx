...
>(({ className, children, ...props }, ref) => {
  ...
  // `context` puede ser null en el primer render (o si TabsList se usa fuera
  // de <Tabs>) — los hooks de abajo tienen que llamarse siempre en el mismo
  // orden, así que el `return null` real se hace más abajo, después de
  // declarar todos los hooks (nunca antes, o React lanza "Rendered fewer
  // hooks than expected" en cuanto context pase de null a no-null).
  ...
  /**
   * Native animated scroll handler — el hook se llama siempre (nunca dentro
   * de una condición, regla de los hooks); solo se usa como `onScroll` en
   * iOS/Android más abajo, web sigue con handleWebScroll.
   */
  ...
  // Guard real: a partir de aquí ya se llamaron todos los hooks de esta
  // función en todos los renders, así que salir antes es seguro.
