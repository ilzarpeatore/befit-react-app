...
// Content no anima entrada/salida por su cuenta (solo Root/Backdrop lo
// hacen), así que puede ser un GlassView directo — Liquid Glass real en
// iOS 26+, <View> normal en cualquier otro caso (ver
// components/ui/glass-view).
...
const popoverContentStyle = tva({
  base: 'text-popover-foreground rounded-lg overflow-hidden border border-border dark:border-border/10 shadow-md p-4 w-full max-w-xs web:pointer-events-auto',
  variants: {
    // bg-popover solo aplica cuando NO hay Liquid Glass real (Android,
    // iOS<26) — con glass real, un fondo opaco encima taparía el material
    // translúcido que ya pinta GlassView.
    hasGlass: {
      true: '',
      false: 'bg-popover',
    },
