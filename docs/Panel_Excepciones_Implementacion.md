...
_Documento de implementación — Panel de Excepciones del Coach. Se apoya íntegramente en las Fases 1-4 del Motor de Auto-Regulación de Carga, ya construidas y verificadas (ver `Motor_Auto_Regulacion_Carga_Instalacion.md`)._
