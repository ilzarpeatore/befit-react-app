...
_(Ambas features consumen `exercise_session_metrics` de Fase 1 y pueden construirse en paralelo; no dependen entre sí.)_
...
_Documento generado a partir de la conversación de desarrollo de Be Stronger — agosto 2026._
