...
*Plan de implementación — pendiente de ejecución. Documento vivo: actualizar con hallazgos reales según se construya cada fase, mismo criterio que `Panel_Excepciones_Implementacion.md`.*
